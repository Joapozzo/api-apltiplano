...
export type UpdateUbicacionBody = Partial<CreateUbicacionBody> & {
    activo?: boolean;
};
...
export type UpdateActividadBody = Partial<CreateActividadBody> & {
    activo?: boolean;
};
export type UpdateDificultadBody = Partial<CreateDificultadBody> & {
    activo?: boolean;
};
//# sourceMappingURL=catalogos.dto.d.ts.map