...
export class ServiciosService {
    ...
    static async create(data) {
        ...
        const servicio = await prisma.servicios.create({
            data: {
                ...
                descripcion_recorrido: data.itinerarios !== undefined ? null : data.descripcion_recorrido || null,
        ...
        if (data.itinerarios !== undefined) {
            await syncItinerariosForServicio(servicio.id_servicio, itinerariosPayload, data.duracion_dias);
        }
    ...
    static async update(id, data) {
        ...
        const servicio = await prisma.servicios.update({
            ...
            data: {
                ...
                temporada_recomendada: data.temporada_recomendada || [],
                experiencia_requerida: data.experiencia_requerida !== undefined
        ...
        if (data.itinerarios !== undefined) {
            await syncItinerariosForServicio(id, itinerariosPayload, data.duracion_dias);
        }
        const servicioConItinerarios = await prisma.servicios.findUnique({
            where: { id_servicio: id },
            include: {
     ...
     */
    static async updateItinerarios(id, data) {
        const existing = await prisma.servicios.findUnique({
            where: { id_servicio: id },
