...
BEGIN
    ...
    IF v_id_servicio IS NULL THEN
        ...
        VALUES (
            ...
            'Un salto al montañismo: 4 días de aventura y aprendizaje rumbo a los 4.350 m del Penitentes.',
            'El Cerro Penitentes se encuentra frente al imponente macizo del Aconcagua, su cumbre es el mirador por excelencia de la pared sur. Su entorno ofrece un paisaje típico de la cordillera frontal: valles amplios, laderas pedregosas, penitentes de hielo y vistas abiertas hacia la alta montaña.',
    ...
    IF v_id_servicio IS NULL THEN
        ...
        VALUES (
            ...
            'Un ascenso inolvidable: naturaleza, altura y aventura en el imponente Tuzgle',
    ...
    IF v_id_servicio IS NULL THEN
        ...
        VALUES (
            ...
            'Viví la cumbre más alta del continente: aventura, altura y montañismo en el Aconcagua.',
    ...
    IF v_id_servicio IS NULL THEN
        ...
        VALUES (
            ...
            14, 13, 6739, 839,
            'El ascenso al Volcán Llullaillaco es una de las grandes aventuras de alta montaña en la Puna de Atacama. Con sus imponentes 6.739 metros, es un volcán cargado de historia y misticismo, conocido por albergar en su cumbre el santuario inca más alto del mundo.',
    ...
    ELSE
        UPDATE servicios SET
            ...
            descripcion_completa = 'El ascenso al Volcán Llullaillaco es una de las grandes aventuras de alta montaña en la Puna de Atacama. Con sus imponentes 6.739 metros, es un volcán cargado de historia y misticismo, conocido por albergar en su cumbre el santuario inca más alto del mundo.',
