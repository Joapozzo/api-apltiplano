  ...
  static async create(data: any) {
    ...
    const servicio = await prisma.servicios.create({
      data: {
        ...
        foto_focal_x:
          data.foto_focal_x != null && Number.isFinite(Number(data.foto_focal_x))
            ? Number(data.foto_focal_x)
            : 0.5,
        foto_focal_y:
          data.foto_focal_y != null && Number.isFinite(Number(data.foto_focal_y))
            ? Number(data.foto_focal_y)
            : 0.5,
        fotos_focal:
          data.fotos_focal && typeof data.fotos_focal === "object" ? data.fotos_focal : {},
      },
      include: {
        lugares: true,
        actividades: true,
  ...
  static async update(id: number, data: any) {
    ...
    const servicio = await prisma.servicios.update({
      ...
      data: {
        ...
        dificultad_tecnica:
          data.dificultad_tecnica !== undefined ? data.dificultad_tecnica || null : null,
        duracion_dias: data.duracion_dias,
        duracion_noches: data.duracion_noches,
        altura_maxima: data.altura_maxima,
