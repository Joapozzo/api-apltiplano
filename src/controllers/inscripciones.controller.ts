...
export class InscripcionesController {
  ...
  static list = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (req.query.expedicion) filters.expedicion = parseInt(req.query.expedicion as string);
    if (req.query.cliente) filters.cliente = parseInt(req.query.cliente as string);
